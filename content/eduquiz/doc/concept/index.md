...
## Сервис цифрового тестирования <a href="https://nla-eduquiz.eduai.pro">NL!A EduQuiz</a> повышает на порядки уровень интерактива и вовлеченности учащихся на традиционных занятиях:
...
#### 😎 Передовые технологии Neuro Lab! Algorithms позволяют создавать тесты на сервисе <a href="https://nla-eduquiz.eduai.pro">NL!A EduQuiz</a> за несколько секунд

{{< img name="files/creategif*" title="EduQuiz тестирование через телефоны" class="article-image">}}
<br><hr><br>

#### Посмотрите видео-инструкцию с описанием, порядоком использования и применения сервиса <a href="https://nla-eduquiz.eduai.pro">NL!A EduQuiz</a>
...
### Для проведения тестирования с помощью сервиса <a href="https://nla-eduquiz.eduai.pro">EduQuiz</a> необходимы:

- Подготовленные тестовые вопросы (в формате электронной таблицы)
...
- Аккаунт в одной из социальных сетей vk.com, facebook.com (для авторизации на сервисе)

<br><br><br>
### Порядок использования сервиса <a href="https://nla-eduquiz.eduai.pro">EduQuiz</a> для преподавателя

1. Создайте тестовые вопросы по изучаемой теме

2. Загрузите вопросы на сервис <a href="https://nla-eduquiz.eduai.pro">EduQuiz</a> (эксель-файлом или через админку)
...
6. Анализируйте результаты тестирования на сервисе <a href="https://nla-eduquiz.eduai.pro">EduQuiz</a>
7. Скачайте эксель-файлы с результатами теста

<br><hr><br>
#### Посмотрите видео-инструкцию о том как создавать тесты на сервисе <a href="https://nla-eduquiz.eduai.pro">NL!A EduQuiz</a> при помощи электронной таблицы (MS Excel)
<br><br>
...
1. создать задания (тесты) на сервисе <a href="https://nla-eduquiz.eduai.pro">EduQuiz</a> в день занятия 

2. провести тестирование своих учеников

3. скачать результаты и исходные вопросы к себе на компьютер

4. удалить задание (или оно удалится автоматически через 23 часа)

<br><hr><br>

### Сервис <a href="https://nla-eduquiz.eduai.pro">EduQuiz</a> позволяет создавать три типа тестовых вопросов:
