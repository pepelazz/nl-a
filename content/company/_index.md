...
<br>
### <font color="orange">Neuro Lab</font>! <font color="orange">Algorithms</font> (<font color="orange">NL</font>!<font color="orange">A</font>) - российская технологическая компания, специализирующаяся на разработке решений, повышающих качество управления в организациях

<br>
<hr><br>
<blockquote>Наша миссия: помогаем решать управленческие задачи наших партнеров за счет использования передовых технологий</blockquote>
<br>
Мы постоянно инвестируем в новые технологии, которые позволяют создавать все более ценные решения для наших партнеров

Мы разрабатываем и постоянно совершенствуем интернет-сервисы, 
которые позволяют нашим клиентам эффективно и результативно решать задачи, связанные с повышением качества 
бизнес-процессов, бизнеса в целом

<hr><br>

## Ключевые особенности наших сервисов:
<ul>
<li>Создаются индивидуально под бизнес-логику заказчика
<li>Работа с данными через мобильные устройства
<li>Быстрая разработка и внедрение
<li>Сопровождаем и оказываем поддержку на всех этапах использования сервисов
</ul>
...
<ul>
<li>Сервис "Цифровой помощник NL!A"
</ul>


<hr><br>
## Цифровые сервисы по обучению и аттестации персонала:
<ul>
<li><a href="#eduai">Цифровая образовательная платформа EduAi</a>
<br>
<li><a href="#eduquiz">Сервис цифрового обучения NL!A EduQuiz</a>
<br>
<li><a href="#edubot">Платформа образовательных чат-ботов NL!A EduBot</a>
<br>
<li><a href="#of">Цифровой курс “Основы финансов”</a>
</ul>
