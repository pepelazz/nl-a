...
title = "Кейс: запуск процесса цифрового обучение сотрудников на базе EduAi в федеральной компании-производителе пищевых продутков"
...
+++
<b>Кейс по запуску цифрового обучения сотрудников на платформе <a href="http://nl-a.ru/eduai/doc/concept/">EduAi</a></b>: Внедрение и запуск системы цифрового обучения сотрудников в федеральной компании - производители пищевых продуктов

### Кейс. Коротко: 

- В рамках политики управления качеством удалось вовлечь в <b>процесс цифрового обучения на платформе <a href="http://nl-a.ru/eduai/doc/concept/">EduAi</a></b> (через мобильные телефоны) <b>98% сотрудников федеральной компании</b>, производящей широкий ассортимент пищевых продуктов
...
В общем решение о переводе максимального количества “обучения” в цифровой формат на нашей платформе <a href="http://nl-a.ru/eduai/doc/concept/">EduAi</a> было принято достаточно быстро и ответственные сотрудники-эксперты были поставлены перед фактом-задачей “оцифровки своих знаний”
...
В итоге на момент боевого массового запуска цифрового обучения в компании было подготовлено и размещено на образовательной платформе <a href="http://nl-a.ru/eduai/doc/concept/">EduAi</a> 119 <b>обучающих курсов</b>, содержащих:
...
Поскольку ключевая концепция обучения сотрудников на платформе <a href="http://nl-a.ru/eduai/doc/concept/">EduAi</a> - это обучение через диалог на тренажерах курсов, то все пользователи системы видят достаточно прозрачную и релевантную картину об интенсивности обучения

<hr>
{{< img name="images/graphstart*" title="NL!A EduAi обучение сотрудников" class="article-image">}}
<hr>

В первый же день в процесс обучения на платформы <a href="http://nl-a.ru/eduai/doc/concept/">EduAi</a> включились 80+ сотрудников, которые в общей сложности ответили на <b>11.622 вопроса</b>. Т.е. в среднем каждый сотрудник за день дал около 150 ответов на вопросы курсов, размещенных на платформе
...
<b>Результат анализа 250.000+ ответов сотрудников на тренажерах курсов на платформе <a href="http://nl-a.ru/eduai/doc/concept/">EduAi</a> - процент верных ответов по дням (по всем сотрудникам в целом за день)</b>

<hr>
{{< img name="images/trend*" title="NL!A EduAi обучение сотрудников" class="article-image">}}
<hr>

Так, если в начале обучения сотрудники заказчика продемонстрировали уровень знаний в диапазон 86%-88%, то в течение 2 недель обучения на тренажерах курсов на платформе <a href="http://nl-a.ru/eduai/doc/concept/">EduAi</a> уровнь знаний уже стал находиться в диапазоне 94%-96%
...
### Промежуточные итоги запуска цифрового обучения на образовательной платформе <a href="http://nl-a.ru/eduai/doc/concept/">EduAi</a>:
