...
title = "Кейс: внедрение EduAi в федеральной компании-производителе пищевых продутков"
titleEn = "eduai_case_foodfactory"
blogtags = ["бизнес", "кейс", "практика", "пример"]
Description = ""
teaser = "Реализовали очень уникальный, интересный и масштабный проект по запуску процесса цифрового обучения на базе нашей образовательной платформы EduAi. В статье описан кейс по запуску цифрового обучения сотрудников на платформе EduAi: Внедрение и запуск системы цифрового обучения сотрудников в федеральной компании - производители пищевых продуктов"

+++
<b>Кейс по запуску цифрового обучения сотрудников на платформе EduAi</b>: Внедрение и запуск системы цифрового обучения сотрудников в федеральной компании - производители пищевых продуктов

### Кейс. Коротко: 

- В рамках политики управления качеством удалось вовлечь в <b>процесс цифрового обучения на платформе EduAi</b> (через мобильные телефоны) <b>98% сотрудников федеральной компании</b>, производящей широкий ассортимент пищевых продуктов
...
Опыт наших предыдущих проектов показывает, что компаниям нужно от 6 до 12 месяцев, чтобы войти во вкус процесса цифрового обучения и аттестации сотрудников, используя возможности нашей платформы EduAi. Компаниям требуются месяцы, чтобы понять, что можно эффективно и гарантированно организовать процесс обучения с одним единственным ответственным за обучение сотрудником, который будет видеть и управлять процессом обучения всей целевой аудитории вне зависимости от их местоположения (владыка мира в центре управления полетами)

В наших предыдущих проектах запуск процесса цифрового обучения персонала на нашей платформе EduAi проходил по линии HR (управления персоналом). Типовая ситуация для российского бизнеса - за обучение персонала отвечает HR (не самое фронт-офисное подразделение в бизнесе, надо признать; отсюда и медленные скорости внедрения, в т.ч.)
...
<hr>
{{< img name="images/quality_management*" title="NL!A EduAi Virtex-food Виртекс фуд обучение сотрудников" class="article-image">}}
<hr>
...
И большинство руководителей понимает, что прохождение / сдача сотрудниками формальных экзаменов - не есть гарантия наличия нужных знаний у каждого рядового сотрудника (но этот подход используется, поскольку не было альтернативы… до EduAi ;)
...
В общем решение о переводе максимального количества “обучения” в цифровой формат на нашей платформе EduAi было принято достаточно быстро и ответственные сотрудники-эксперты были поставлены перед фактом-задачей “оцифровки своих знаний”
...
Конфликтную позицию заняли только представители инженерного подразделения, заявившие о невозможности отвлечения ресурсов для составления обучающих вопросов для тренажеров платформы EduAi. В итоге, чтобы сдвинуть ситуацию, нам пришлось предложить свои услуги по обработке материалов инженерного подразделения и составлении обучающих вопросов….
...
<hr>
{{< img name="images/knowledge_management*" title="NL!A EduAi Virtex-food Виртекс фуд обучение сотрудников" class="article-image">}}
<hr>
...
В итоге на момент боевого массового запуска цифрового обучения в компании было подготовлено и размещено на образовательной платформе EduAi 119 <b>обучающих курсов</b>, содержащих:
...
<blockquote>Но в первый же день - бомбануло их всех орудий </blockquote>

Руководители просто дали ссылку своим сотрудникам … и процесс пошел, люди включились

Поскольку ключевая концепция обучения сотрудников на платформе EduAi - это обучение через диалог на тренажерах курсов, то все пользователи системы видят достаточно прозрачную и релевантную картину об интенсивности обучения

<hr>
{{< img name="images/graphstart*" title="NL!A EduAi Virtex-food Виртекс фуд обучение сотрудников" class="article-image">}}
<hr>

В первый же день в процесс обучения на платформы EduAi включились 80+ сотрудников, которые в общей сложности ответили на <b>11.622 вопроса</b>. Т.е. в среднем каждый сотрудник за день дал около 150 ответов на вопросы курсов, размещенных на платформе
...
<b>Результат анализа 250.000+ ответов сотрудников на тренажерах курсов на платформе EduAi - процент верных ответов по дням (по всем сотрудникам в целом за день)</b>

<hr>
{{< img name="images/trend*" title="NL!A EduAi Virtex-food Виртекс фуд обучение сотрудников" class="article-image">}}
<hr>

Так, если в начале обучения сотрудники заказчика продемонстрировали уровень знаний в диапазон 86%-88%, то в течение 2 недель обучения на тренажерах курсов на платформе EduAi уровнь знаний уже стал находиться в диапазоне 94%-96%
...
<hr>
{{< img name="images/timesite*" title="NL!A EduAi Virtex-food Виртекс фуд обучение сотрудников" class="article-image">}}
<hr>
...
<hr>
{{< img name="images/weekend*" title="NL!A EduAi Virtex-food Виртекс фуд обучение сотрудников" class="article-image">}}
<hr>
...
<hr>
{{< img name="images/night*" title="NL!A EduAi Virtex-food Виртекс фуд обучение сотрудников" class="article-image">}}
<hr>
...
<hr>
{{< img name="images/devices*" title="NL!A EduAi Virtex-food Виртекс фуд обучение сотрудников" class="article-image">}}
<hr>

### Промежуточные итоги запуска цифрового обучения на образовательной платформе EduAi:
