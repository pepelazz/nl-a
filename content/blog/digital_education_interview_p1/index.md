...
title = "Для успешного применения цифровых технологий необходимо перестраивать свое мышление"
titleEn = "biz_words"
...
Ученик запрашивает задачу
1. Гаджет предоставляет задачу (моментально)
2. Ученик решает задачу, вводит ответ
3. Происходит моментальная проверка ответа и предоставляется обратная связь
4. Ученик запрашивает следующую задачу
