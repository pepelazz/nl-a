...
Description = ""
teaser = "Основы финансов. Массовый открытый онлайн курс"

+++

В 2014 году Новосибирским Государственным Университетом (НГУ) на базе Центра Дополнительного Образования (ЦДО НГУ) при поддержке Министерства Финансов Российской Федерации инициирован проект «Создание и регулярное проведение массового открытого он-лайн курса «Основы финансов для молодежи».
...
Он-лайн курс создается на базе следующих принципов:
...
Материалы онлайн-курса «Основы финансов» доступны для публичного доступа на разработанной веб-платформе по адресу основы-финансов.рф и osnovi-finansov.ru.
