...
<blockquote><b>Если происходит подобная подмена, то для корректного использования курсов на платформе EduAi необходимо сменить веб-браузер и продолжить обучение через новый браузер</b></blockquote>
