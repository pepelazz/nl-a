...
2. <b>Проходной балл</b> - количество баллов, которое должен набрать пользователь для того чтобы экзамен считался сданным. По умолчанию один вопрос "оценивается" в 10 баллов (параметр задается для каждого вопроса на этапе создания / измнения вопроса)

3. <b>Количество вопросов</b> - количество вопросов, которое будет задано в рамках экзамена. При создании экзамен ВАЖНО учитывать связь параметра "проходной балл" и "количество вопросов". В данном примере логика: 20 вопросов * 10 баллов * 80% (проходной порог) = 160 баллов проходной порог
